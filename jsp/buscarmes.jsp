			...
			<div class="row">
                ...
                <div class="col-lg-8 col-md-10 col-sm-10">
                    <br><br><br>
                     <table class="table table-striped table-bordered text-center">
                        ...
                        <%
                            ...
                            PreparedStatement amigos = conexao.prepareStatement("SELECT * FROM amigos WHERE MONTH(datanasc) = ?");
                            amigos.setInt(1, mes);
                    ...
                    <%
                        ...
                        if(count == 0) {
                            out.println("<div class='alert alert-danger text-center'><i class='fa fa-times-circle'></i>  Nao foram encontrados registro para o mes pesquisado" + "</div>");
                        } else {
